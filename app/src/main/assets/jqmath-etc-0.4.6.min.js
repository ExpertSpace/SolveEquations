...
var jqMath = function() {
        ...
        function r(r) {
            ...
            if ("mi" == a) !r.getAttribute("mathvariant") && r.firstChild && 3 == r.firstChild.nodeType && r.setAttribute("mathvariant", 1 == r.firstChild.data.length ? "italic" : "normal");
                ...
                for (var u = [o[0]], l = 1; l < o.length; l++)
                    if ("mprescripts" != o[l].tagName) {
        ...
        function N() {
            for (var t = e.re_.exec(Q); !t;) {
                ...
                var r = V[W++];
                if ("string" == typeof r) e.re_.lastIndex = 0, Q = r, t = e.re_.exec(Q);
                else {
        ...
        e.newMe = function(s, o, u, l) {
            ...
            "math" == s && (s = "fmath");
            var m = D(t(l.createElement(s.toUpperCase()), o)),
                f = O.slice(m[0].childNodes);
            ...
            if ("fmath" == s || "mn" == s || "mtext" == s || "mprescripts" == s || "none" == s);
                ...
                var g = O.applyF(Math.max, c),
                    v = O.applyF(Math.max, p);
        ...
        return e.sMxAToMe = function(t, r) {
            r || (r = document), e.infix_[""] && e.infix_[","] || O.err(err_sToMe_1_),
            void 0 === e.MathML && (e.MathML = e.canMathML()), e.re_.lastIndex = 0, Q = "", V = Array.isArray(t) ? t : [t], W = 0, H = r, X = e.infix_[""];
            var n = j(0);
                ...
                if ("MATH" == t.tagName.toUpperCase()) {
                    ...
                    for (var n = t.firstChild; n;) {
                        ...
                        for (var i = t.ownerDocument, s = t.data, o = [], u = "", l = /\\([$\\])|\$\$?|\\[([]/g;;) {
                            ...
                            if (c > m && (u += s.substring(m, c)), f && f[1]) u += f[1];
                            else {
                                var p, d = -1;
                                if (f) {
                                    if (p = "\\(" == f[0] ? "\\)" : "\\[" == f[0] ? "\\]" : f[0], l.lastIndex < s.length && ("$" != f[0] || e.$mathQ))
                                        for (d = s.indexOf(p, l.lastIndex); - 1 != d && "\\" == s.charAt(d - 1);) d = s.indexOf(p, d + 1);
                                    if (-1 == d) {
                                        u += f[0];
                                        continue
                                    }
                                ...
                                var h = "$$" == f[0] || "\\[" == f[0],
                                    g = e.sToMathE(s.substring(l.lastIndex, d), h, i);
